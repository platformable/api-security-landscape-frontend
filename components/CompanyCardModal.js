  ...
  const router = useRouter();
    return (
        ...
        <div className="card-top">
            ...
            {company.logo === "" || null ? <img src={`https://res.cloudinary.com/platformable/image/upload/v1648805011/apilandscape/GitHub-Logo_g5x9hs.png`} alt=""  className=""/> : <img srcset={`${handleImages(company.logo)} 2x`} alt="" className="img-fluid" /> }
